...
function main(){
    ...
    // iOS
    createScreenshot( "iOS", "iPhone XsMax Portrait iOS 11+", 1242, 2688, 0);
    createScreenshot( "iOS", "iPhone XsMax Landscape iOS 11+", 2688, 1242, 0);

    createScreenshot( "iOS", "iPhone Xr Portrait iOS 11+", 828, 1792, 0);
    createScreenshot( "iOS", "iPhone Xr Landscape iOS 11+", 1792, 828, 0);
